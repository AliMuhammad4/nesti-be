...
export const generateStorefrontDraftSchema = Joi.object({
  ...
  brand_kit: Joi.object({
    ...
    cover_url: Joi.string().uri().allow('').optional(),
    profile_photo_url: Joi.string().uri().allow('').optional(),
    logo_size: Joi.number().integer().min(24).max(72).optional(),
    ...
    secondary_color: Joi.string().pattern(/^#[0-9A-Fa-f]{6}$/).allow('').optional(),
    ...
    font_family: Joi.string().trim().max(120).allow('').optional(),

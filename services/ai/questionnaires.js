...
export const QUESTIONNAIRES = {
  ...
  [PROFESSIONAL_TYPE.LAWYER]: {
    ...
    questions: [
      ...
      { id: 'legal_services_needed', field: 'legal_services_needed', question: 'What legal services do you need?', type: 'select', max_points: 10, options: [{ value: 'full_closing', label: 'Full closing services', points: 10 }, { value: 'purchase_closing', label: 'Purchase closing', points: 10 }, { value: 'sale_closing', label: 'Sale closing', points: 10 }, { value: 'refinance_legal_work', label: 'Refinance legal work', points: 7 }, { value: 'agreement_review', label: 'Agreement / contract review', points: 6 }, { value: 'title_transfer', label: 'Title transfer', points: 7 }, { value: 'document_review', label: 'Document review', points: 5 }, { value: 'mortgage_document_review', label: 'Mortgage document review', points: 6 }, { value: 'property_dispute_advice', label: 'Property dispute / legal advice', points: 5 }, { value: 'other', label: 'Other legal service', points: 3 }] },
